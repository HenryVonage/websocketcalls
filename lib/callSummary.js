...
// Retries a few times with short delays — right after a call ends,
// ElevenLabs may not have finished persisting the transcript yet.
async function fetchTranscriptWithRetry(conversationId, attempts = 4, delayMs = 2000) {
