...
function buildAnswerNcco({ context, callerPhone, callUuid, conversationUuid }) {
      ...
      endpoint: [
        {
          ...
          headers: {
            ...
            callUuid: callUuid || '',
            // Lets the realtime bridge tell store.js which callContext
            // entry to attach the ElevenLabs conversation_id to, once it
            // learns it — this is the same key handleEvents() looks up by.
