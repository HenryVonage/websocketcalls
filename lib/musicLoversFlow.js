...
const { resolveWikipediaUrl, resolveGeniusUrl } = require('./linkResolvers');
...
async function handleExploreMoreFlowCompletion(body, state) {
  ...
  // Songkick's API needs an approved key (applied for, pending as of Sept
  // 2026 — up to 30 working days per their support docs) before this can
  // resolve to a direct artist page the same way lyrics/bio do above.
  // Stays a search-results link until that key lands.
