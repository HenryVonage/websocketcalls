...
STAGE "AWAITING_SEAT" (asked the visitor for their row & seat, or to upload their ticket):
  ...
  - message close to 'other question', or a genuine question → FAQ answer, and stay on this stage
  - anything else unclear (not a row/seat, not a question) → output exactly: [T_GENERIC_HELP]
...
STAGE "CONFIRMING_SEAT" (visitor was just asked to confirm their row/seat is correct):
  ...
  - message close to 'other question', or a genuine question → FAQ answer, and stay on this stage
  - unclear (not yes/no, not a question) → plain text asking them to confirm yes/no, no marker
