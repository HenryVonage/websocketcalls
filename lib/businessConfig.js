...
module.exports = {
  ...
  // Defaults to the same identifier used as "from" when sending RCS
  // messages — adjust if Vonage's dashboard shows a different Sender ID.
  RCS_AGENT_SENDER_ID: 'henry_rcs_demo3_byrrgzuw_agent@rbm.goog',
