...
module.exports = {
  ...
  TICKETING: {
    ...
    WHATSAPP: {
      ...
      //   henry_ticketing3 — DOCUMENT header (the venue map PDF) + 2 body
      //     vars (name, event name) — used for the "one week to go"
      //     reminder, WhatsApp's PDF-map counterpart to the RCS map image.
      ...
      TEMPLATE_ONE_WEEK_MAP: 'henry_ticketing3',
